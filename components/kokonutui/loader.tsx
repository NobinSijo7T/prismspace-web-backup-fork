  ...
  return (
    ...
    >
      ...
      >
        ...
        {mintAccent && (
          <div
            className="absolute inset-0 rounded-full blur-xl pointer-events-none opacity-25 dark:block hidden"
            style={{
              background: "radial-gradient(circle, rgba(0, 223, 129, 0.5) 0%, transparent 70%)",
            }}
          />
        )}
        ...
        <motion.div
          ...
          style={{
            background: mintAccent
              ? "conic-gradient(from 0deg, transparent 0deg, rgb(255, 255, 255) 120deg, rgba(0, 223, 129, 0.6) 240deg, transparent 360deg)"
        ...
        <motion.div
          ...
          style={{
            background: mintAccent
              ? "conic-gradient(from 270deg, transparent 0deg, rgba(0, 223, 129, 0.7) 20deg, transparent 40deg)"
